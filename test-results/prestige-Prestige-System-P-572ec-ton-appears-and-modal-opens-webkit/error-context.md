...
- Name: Prestige System >> Prestige button appears and modal opens
- Location: /Users/shanesweeney/Documents/GitHub/Cosmic-Clicker/tests/prestige.spec.ts:4:3
...
Locator: locator('[data-testid="prestige-confirm-btn"]')
Expected: enabled
Received: disabled
Call log:
  - expect.toBeEnabled with timeout 5000ms
  - waiting for locator('[data-testid="prestige-confirm-btn"]')
    9 × locator resolved to <button disabled data-testid="prestige-confirm-btn" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-6 rounded shadow">Prestige</button>
      - unexpected value "disabled"

    at /Users/shanesweeney/Documents/GitHub/Cosmic-Clicker/tests/prestige.spec.ts:31:72
```
