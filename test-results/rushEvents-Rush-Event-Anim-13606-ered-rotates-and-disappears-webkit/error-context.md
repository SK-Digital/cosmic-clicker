...
Call log:
  - waiting for locator('.rush-blackhole') to be detached
    52 × locator resolved to visible <div class="rush-blackhole fixed inset-0 pointer-events-none z-40 flex items-center justify-center">…</div>
...
- list:
  - listitem:
    - img
    - text: "Black Hole Rift Time left: 7s"
