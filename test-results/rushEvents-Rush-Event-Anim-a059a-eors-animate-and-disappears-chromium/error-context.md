...
- Name: Rush Event Animations >> Meteor shower animation appears, meteors animate, and disappears
- Location: /Users/shanesweeney/Documents/GitHub/Cosmic-Clicker/tests/rushEvents.spec.ts:25:3
...
Call log:
  - waiting for locator('.rush-meteor').first() to be detached
    63 × locator resolved to visible <div aria-hidden="true" class="rush-meteor"></div>

    at /Users/shanesweeney/Documents/GitHub/Cosmic-Clicker/tests/rushEvents.spec.ts:30:26
```
...
- list:
  - listitem:
    - img "Meteor"
    - text: "Meteor Shower Time left: 1s"
